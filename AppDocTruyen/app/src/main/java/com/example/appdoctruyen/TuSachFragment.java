...
public class TuSachFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager = (ViewPager) view.findViewById(R.id.vpTuSach);
        adapter = new ViewPaperAdapter(getFragmentManager());

        adapter.addFragment(new DaXemFragment(),"Đã xem");
        adapter.addFragment(new TheoDoiFragment(),"Theo dõi");
